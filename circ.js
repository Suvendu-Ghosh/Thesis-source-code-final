...
// Resistor function will have store position and value----
...
// when I will drag registar in the area how register will be drawn is described here
...
function simulateCircuit(debug) {
  ...
  if (bBothLeadsConnected) {
    ...
    //So basically the voltage of the red lead will pass as a parameter in the function printoutput which was described in the module util.js and called fromt this try catch block.
